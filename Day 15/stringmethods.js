...
const string = "my name is Manahil Malik, age is 20, gender is F";
...
console.log('the string includes "Manahil": ', string.includes("Manahil"));
console.log('the string starts with "m": ', string.startsWith("m"));
console.log('the string ends with "F": ', string.endsWith("F"));

///////////////////////////////.slice////////////////////////////////////////////
console.log("the name is: ", string.slice(11, 25)); // extracts "Manahil Malik"
